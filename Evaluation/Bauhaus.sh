...
RESULTS=$(date '+%y%m%d')_HMSDK_reorder_PEBS_${LOCAL_MEM_SIZE}_${CXL_MEM_SIZE_2}
...
QDRANT_DATASET_DIR=/home/new_cloud_cxl/extra_space_2TB/binbin/test/qdrant_server_c4_reorder_new
...
# QDRANT_DATASET_DIR=/home/new_cloud_cxl/binbin/PubMed_miniLM/qdrant_server_PubMed_reorder
...
# QDRANT_DATASET_DIR=/home/new_cloud_cxl/binbin/c4_bge/qdrant_server_c4_bge_reorder
# EMBEDDED_QUESTION_DIR=/home/new_cloud_cxl/binbin/c4_bge/NQ_default_bge_embedded_question_7830
# QUESTION_DIR=/home/new_cloud_cxl/extra_space_2TB/binbin/test/NQ_default_question_7830

### pubmed & bioasq dataset (bge-base-en-v1.5) & need 3KB kernel, Embedding model change in GPU
# QDRANT_DATASET_DIR=/home/new_cloud_cxl/binbin/PubMed_bge/qdrant_server_PubMed_reorder
